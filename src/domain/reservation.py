...
class Reservation:
    def __init__(self, db_id=None, reservation_id=None, room_id=None, guest_name=None, number_of_guests=None, check_in_date=None, check_out_date=None):
        self.__db_id = db_id
    ...
    def __str__(self):
        return f'Room: {self.__room_id} | Guest name: {self.__guest_name} | Number of guests: {self.__number_of_guests} | Check-in: {self.__check_in_date.isoformat()} | Check-out: {self.__check_out_date.isoformat()}'
